...
Body = namedtuple('Body', ['rot_per', 'radius', 'mu', 'mass', 'orbit_sma',
                           'orbit_per', 'orbit_ecc', 'orbit_inc', 'mass', 'p'])

# define sun constants
sun = Body(rot_per=0.0394011, radius=695990.0, mu=1.32712000e11,
           mass=1.32712000e11 / G, orbit_sma=0, orbit_per=0, orbit_ecc=0,
           orbit_inc=0, mass=0, p=0)


# define moon constants
constants.moon.rot_per      =   .0366004;
constants.moon.radius       =   1737.50;
constants.moon.mu           =   4.902800e3;
constants.moon.orbit_sma    =   3.84400000e5; % about the Earth
constants.moon.orbit_per    =   2360592;
constants.moon.orbit_ecc    =   .05540000;
constants.moon.orbit_inc    =   5.16000;
constants.moon.mass          =   constants.moon.mu/constants.G;
constants.moon.p            =   constants.moon.orbit_sma*(1-constants.moon.orbit_ecc^2);
% mercury
constants.mercury.rot_per   =   .0170515;
constants.mercury.radius    =   2.439000e3;
constants.mercury.mu        =   2.203210e4;
constants.mercury.orbit_sma =   5.79092000e7;
constants.mercury.orbit_per =   7600568.601;
constants.mercury.orbit_ecc =   0.205631;
constants.mercury.orbit_inc =   7.00487;
constants.mercury.mass          =   constants.mercury.mu/constants.G;
constants.mercury.p            =   constants.mercury.orbit_sma*(1-constants.mercury.orbit_ecc^2);

% venus
constants.venus.rot_per     =   .0041149;
constants.venus.radius      =   6051.80;
constants.venus.mu          =   3.24859000e5;
constants.venus.orbit_sma   =   1.0820900e8;
constants.venus.orbit_per   =   19414191.77;
constants.venus.orbit_ecc   =   .006773;
constants.venus.orbit_inc   =   3.39471;
constants.venus.mass          =   constants.venus.mu/constants.G;
constants.venus.p            =   constants.venus.orbit_sma*(1-constants.venus.orbit_ecc^2);

% earth
constants.earth.rot_per     =   1.0027576;
constants.earth.radius      =   6378.14;
constants.earth.mu          =   3.9860000e5;
constants.earth.orbit_sma   =   1.49589800e8;
constants.earth.orbit_per   =   31555647.16;
constants.earth.orbit_ecc   =   .01671020;
constants.earth.orbit_inc   =   4.98816000e-5;
constants.earth.mass          =   constants.earth.mu/constants.G;
constants.earth.p            =   constants.earth.orbit_sma*(1-constants.earth.orbit_ecc^2);
% mars
